...
export default function SignUp() {
  ...
  return (
    ...
    >
      {error.form && <p className="text-red-500 text-xs font-bold -mb-2">{error.form}</p>}
      ...
      />
      {error.name && <p className="text-red-500 text-xs font-bold -mb-2">{error.name}</p>}
    </div>
    ...
    <div className="flex flex-col gap-2">
      ...
      <input
        ...
        className="bg-surface border border-border rounded-lg h-11 px-4 font-body text-sm text-foreground placeholder:text-muted/50 focus:outline-none focus:border-signal transition-colors"
      />
      {error.number && <p className="text-red-500 text-xs font-bold -mb-2">{error.number}</p>}
    </div>
    ...
    <div className="flex flex-col gap-2">
      ...
      <input
        ...
        className="bg-surface border border-border rounded-lg h-11 px-4 font-body text-sm text-foreground placeholder:text-muted/50 focus:outline-none focus:border-signal transition-colors"
      />
      {error.email && <p className="text-red-500 text-xs font-bold -mb-2">{error.email}</p>}
    </div>
    ...
    <div className="flex flex-col gap-2">
      ...
      <input
        ...
        className="bg-surface border border-border rounded-lg h-11 px-4 font-body text-sm text-foreground placeholder:text-muted/50 focus:outline-none focus:border-signal transition-colors"
      />
      {error.password && <p className="text-red-500 text-xs font-bold -mb-2">{error.password}</p>}
    </div>
