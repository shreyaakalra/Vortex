...
const recentActivity = [
  { name: "arjun.k", time: "today, 2:14 pm", amount: "+₹1,200.00", direction: "in" },
  { name: "the chai stall", time: "today, 9:02 am", amount: "−₹40.00", direction: "out" },
  { name: "rohan.v", time: "yesterday, 6:40 pm", amount: "−₹850.00", direction: "out" },
];
  ...
  return (
    <div className="px-10 py-8">
              ...
              <AreaChart data={balanceHistory}>
                <defs>
                  <linearGradient id="balanceFill" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#3ECF6C" stopOpacity={0.25} />
                    <stop offset="100%" stopColor="#3ECF6C" stopOpacity={0} />
                  </linearGradient>
                </defs>
                <XAxis
                  dataKey="day"
                  axisLine={false}
                  tickLine={false}
                  tick={{ fill: "#8A8D91", fontSize: 10, fontFamily: "JetBrains Mono" }}
                />
                <Tooltip
                  contentStyle={{
                    background: "#0B0D0F",
        ...
        >
          <div className="bg-surface border border-border rounded-2xl p-6">
            ...
            <div className="flex items-baseline gap-2 mt-2">
              ...
              <span className="font-mono text-[10.5px] text-muted">received</span>
            </div>
            <div className="flex items-baseline gap-2 mt-1">
              <span className="font-display font-bold text-xl text-foreground">
                −₹15,890
              </span>
              <span className="font-mono text-[10.5px] text-muted">sent</span>
            </div>
          </div>
          ...
          <div className="bg-surface border border-border rounded-2xl p-6">
            ...
            <div className="flex items-center justify-center py-4">
              <div className="w-20 h-20 rounded-lg border border-border flex items-center justify-center">
                <i className="ti ti-qrcode text-3xl text-muted" aria-hidden="true" />
              </div>
            </div>
      ...
      <div className="flex items-center justify-between mb-3.5">
        ...
        <span className="font-mono text-xs text-signal cursor-pointer">view all</span>
      </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              >
                <i
                  className={`ti ${
                    tx.direction === "in" ? "ti-arrow-down-left" : "ti-arrow-up-right"
              ...
              <div>
                ...
                <div className="font-mono text-[10.5px] text-muted">{tx.time}</div>
              </div>
            </div>
            <span
